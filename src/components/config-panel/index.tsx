...
export const ConfigPanel = () => {
    ...
    const [penLast, setPenLast] = useState(false);
    const {drawPen, createPreview} = useDrawPen();
    const {addImage, rotateImage} = useDrawImage();
    ...
    const openSubMenu = (selectedSub: SubMenuItems) => {
                subMenu(selectedSub);
    ...
    return (
        ...
        <div className="configContainer">
            ...
            <div className={expand ? 'menu-show' : 'menu-hide'}>
                ...
                <div className="configButton" onClick={() => addPicture()}>
                ...
                <div className="configButton" onClick={() => rotateImage()} >
                ...
                <div className="configButton" onClick={() => openSubMenu(SubMenuItems.layerMenu)}>
                    <LayersMenu />
                </div>
            </div>
        </div>
